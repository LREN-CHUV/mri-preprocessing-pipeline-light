function NiiConvert_MPM_Computation(SubjectFolder,SubjID,NiFti_OutputFolder,NiFti_Server_OutputFolder,ProtocolsFile,PipelineParmsConfigFile,OutputFolder,ServerFolder)
...
Preproc_mpm_maps(NiFti_OutputFolder,SubjID,OutputFolder,ProtocolsFile,PipelineParmsConfigFile,ServerFolder);
